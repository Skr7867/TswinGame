...
class ApiUrl {
  ...
  // static const String baseUrl = 'https://root.tswin.app/';
  static const String baseUrl = 'https://tswin.tswin.in/';
 ...
 // static const String aviatorWebSocket = "http://13.235.103.93:3006";
  ...
  // static const String usdtdeposit = "https://tswinr.live/admin/api/pending_payment.php";
  // static const String usdtdepositHistory = "https://tswinr.live/admin/api/pendingPayment_history.php?";
  // static const String usdtQrcodeApi = "https://tswinr.live/admin/index.php/Mahajongapi/usdt_slider";
  // static const String usdtQrcodeImage = "https://admin.tswinr.live/images/1711803944_IMG_20240330_180436.jpg";
  // static const String userblock = "https://admin.tswinr.live/api/auth-check-";
  ...
  static const String sendOtpRegister = "${configModel}otp-register";
  static const String forgetPasswordUrl = "${configModel}updatePassword";
  ...
  static const String gamesRule = "${configModel}gamerules/";
