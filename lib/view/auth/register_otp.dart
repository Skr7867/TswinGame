...
import 'package:tswin/view/account/about_us_screen/about_new.dart';
...
import 'package:tswin/res/components/text_field.dart';
...
class _RegisterScreenOtpState extends State<RegisterScreenOtp> {
                          ...
                          CustomTextSpan(
                            ...
                            spanTap: () {
                              Navigator.push(context, MaterialPageRoute(builder: (context)=>const AboutNewPage(
                                  name:"Risk Disclosure Agreement",type:"10"
                              )));
                            },
                          ),
                        ],
                  ...
                  child: AppBtn(
                      ...
                      onTap: () {
                        if(phoneCon.text.isEmpty || phoneCon.text.length!=10){
                          ...
                          Utils.flushBarErrorMessage("Confirm your password", context, Colors.red);
                        ...
                        }else if(readAndAgreePolicy==false){
                          Utils.flushBarErrorMessage("Please confirm privacy agreement", context, Colors.red);
                        }
                        else {
  ...
  otpMatch(context,String myControllers,String Phone) async {
    final response = await http.get(
    ...
    if(data["error"]=="200"){
      ...
      SendOtp(context,Phone,myControllers);
      Utils.flushBarSuccessMessage(data["msg"], context, Colors.white);
    }else {
      setState(() {
        show = false;
  ...
  SendOtp(context,String mobile, String myControllers) async {
