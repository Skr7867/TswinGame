...
import 'package:tswin/model/custmer_service_model.dart';
...
import 'package:tswin/view/home/widgets/category_elements.dart';
import 'package:tswin/view/home/widgets/category_widgets.dart';
import 'package:tswin/view/home/widgets/slider_widget.dart';
import 'package:flutter/material.dart';
import 'package:http/http.dart' as http;
import 'package:url_launcher/url_launcher.dart';
import 'package:tswin/view/home/widgets/winning_information.dart';
...
class _HomeScreenState extends State<HomeScreen> {
  ...
  Widget build(BuildContext context) {
    ...
    _launchChannel() async {
      var url = "https://t.me/tswingame_official";
      if (await canLaunch(url)) {
        await launch(url);
      } else {
        throw 'Could not launch $url';
    ...
    return Scaffold(
      ...
      appBar: GradientAppBar(
          centerTitle: true,
          title: Text("Tswin",style: TextStyle(
