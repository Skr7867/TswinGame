...
import 'package:tswin/model/vip_bet_card_/model.dart';
import 'package:tswin/model/viphistorymodel.dart';
...
import 'package:tswin/res/provider/vipcardProvider.dart';
import 'package:tswin/utils/utils.dart';
import 'package:tswin/view/account/vip_history.dart';
import 'package:tswin/view/home/mini/Aviator/progressbar.dart';
...
class _VipScreenNewState extends State<VipScreenNew> {
  ...
  Future<void> vipHistoryList() async {
    ...
    final response = await http.get(Uri.parse('${ApiUrl.vipHistory}$token&limit=4'),
      headers: <String, String>{
        'Content-Type': 'application/json; charset=UTF-8',
      },
    );
    print('${ApiUrl.vipHistory}$token&limit=4');
    print('ApiUrl.vipHistory');
    setState(() {
