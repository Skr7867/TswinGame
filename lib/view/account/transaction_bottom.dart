...
import 'package:tswin/model/all_transction_model.dart';
...
class _TransactionBottomState extends State<TransactionBottom> {
  ...
  Future<void> allTransctionHistory() async {
    ...
    final response = await http.get(Uri.parse(_selectedDate==null?'${ApiUrl.allTranscation}$token&subtypeid=${widget.id}':'${ApiUrl.allTranscation}$token&subtypeid=${widget.id}&created_at=$_selectedDate'),
