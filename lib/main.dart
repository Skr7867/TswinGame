import 'package:tswin/model/colorPredictionResult_provider.dart';
import 'package:tswin/res/app_constant.dart';
import 'package:tswin/res/provider/TermsConditionProvider.dart';
import 'package:tswin/res/provider/aboutus_provider.dart';
import 'package:tswin/res/provider/addacount_controller.dart';
import 'package:tswin/res/provider/auth_provider.dart';
import 'package:tswin/res/provider/betColorPrediction_provider.dart';
import 'package:tswin/res/provider/betcolorpredictionTRX.dart';
import 'package:tswin/res/provider/contactus_provider.dart';
import 'package:tswin/res/provider/feedback_provider.dart';
import 'package:tswin/res/provider/giftcode_provider.dart';
import 'package:tswin/res/provider/plinko_bet_provider.dart';
import 'package:tswin/res/provider/privacypolicy_provider.dart';
import 'package:tswin/res/provider/profile_provider.dart';
import 'package:tswin/res/provider/slider_provider.dart';
import 'package:tswin/res/provider/user_view_provider.dart';
import 'package:tswin/utils/routes/routes.dart';
import 'package:tswin/utils/routes/routes_name.dart';
import 'package:flutter/foundation.dart';
import 'package:flutter/material.dart';
import 'package:tswin/view/home/mini/Aviator/AviatorProvider.dart';
